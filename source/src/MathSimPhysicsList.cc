...
// ********************************************************************
//
/// \file MathSimPhysicsList.cc
/// \brief Implementation of the  MathSimPhysicsList class
//
//
//
...
MathSimPhysicsList::MathSimPhysicsList():
G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}
...
void MathSimPhysicsList::ConstructParticle()
{
...
void MathSimPhysicsList::ConstructAllBosons()
{
...
void MathSimPhysicsList::ConstructAllLeptons()
{
...
void MathSimPhysicsList::ConstructAllMesons()
{
...
void MathSimPhysicsList::ConstructAllBaryons()
{
...
void MathSimPhysicsList::ConstructAllIons()
{
...
void MathSimPhysicsList::ConstructAllShortLiveds()
{
...
void MathSimPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructLeptHad();
...
void MathSimPhysicsList::ConstructEM()
{
...
void MathSimPhysicsList::ConstructHad()
{
...
void MathSimPhysicsList::ConstructLeptHad()
{;}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

#include "G4Decay.hh"
void MathSimPhysicsList::ConstructGeneral()
{
...
void MathSimPhysicsList::SetCuts()
{
  if (verboseLevel >0)
  {
    G4cout << "MathSimPhysicsList::SetCuts:";
