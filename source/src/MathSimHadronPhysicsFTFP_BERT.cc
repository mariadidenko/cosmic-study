...
#include "MathSimHadronPhysicsFTFP_BERT.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(MathSimHadronPhysicsFTFP_BERT);

MathSimHadronPhysicsFTFP_BERT::MathSimHadronPhysicsFTFP_BERT(G4int) :
MathSimHadronPhysicsFTFP_BERT("hInelastic FTFP_BERT",false)
{}

MathSimHadronPhysicsFTFP_BERT::MathSimHadronPhysicsFTFP_BERT(const G4String& name, G4bool qe)
...
MathSimHadronPhysicsFTFP_BERT::~MathSimHadronPhysicsFTFP_BERT()
{}

void MathSimHadronPhysicsFTFP_BERT::ConstructParticle()
{
...
void MathSimHadronPhysicsFTFP_BERT::DumpBanner()
{
  ...
  G4cout << G4endl
       ...
       <<"!!!!!!!!!!!!!!!! USE FACTOR XS: "<<useFactorXS<<G4endl
       << G4endl;
}

void MathSimHadronPhysicsFTFP_BERT::CreateModels()
{
  Neutron();
  Proton();
  Pion();
...
void MathSimHadronPhysicsFTFP_BERT::Neutron()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
  G4bool useFactorXS = param->ApplyFactorXS();
...
void MathSimHadronPhysicsFTFP_BERT::Proton()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
  G4bool useFactorXS = param->ApplyFactorXS();
  G4cout<<"!!!!!!!!!!!!!!!! USE FACTOR XS: "<<useFactorXS<<G4endl;
...
void MathSimHadronPhysicsFTFP_BERT::Pion()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
  G4bool useFactorXS = param->ApplyFactorXS();
  G4cout<<"!!!!!!!!!!!!!!!! USE FACTOR XS: "<<useFactorXS<<G4endl;
...
void MathSimHadronPhysicsFTFP_BERT::Kaon()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
  G4bool useFactorXS = param->ApplyFactorXS();
  G4cout<<"!!!!!!!!!!!!!!!! USE FACTOR XS: "<<useFactorXS<<G4endl;
...
void MathSimHadronPhysicsFTFP_BERT::Others()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
...
void MathSimHadronPhysicsFTFP_BERT::ConstructProcess()
{
  G4HadronicParameters* param = G4HadronicParameters::Instance();
  minFTFP_pion = param->GetMinEnergyTransitionFTF_Cascade();
  maxBERT_pion = param->GetMaxEnergyTransitionFTF_Cascade();
